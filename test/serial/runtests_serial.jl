...
#    @test Run_test_channel_blocks(;b=1, Ha=10.0) ≈ kp_shercliff_cartesian(1.0,10.0) atol=0.01
"""
    @test Run_test_multigrid(;b=1, Ha=10.0) ≈ kp_shercliff_cartesian(1.0,10.0) atol=0.01 
